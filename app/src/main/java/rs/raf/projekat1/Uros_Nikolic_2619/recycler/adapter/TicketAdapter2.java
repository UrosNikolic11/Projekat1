...
public class TicketAdapter2 extends ListAdapter<Ticket, TicketAdapter2.ViewHolder> {
    ...
    public TicketAdapter2(@NonNull DiffUtil.ItemCallback<Ticket> diffCallback, Consumer<Ticket> onTicketClicked, Consumer<Ticket> onDesnoClicked, Consumer<Ticket> onLevoClicked, String user) {
        super(diffCallback);
    ...
    @NonNull
    @Override
    public TicketAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TicketAdapter2.ViewHolder holder, int position) {
        Ticket ticket = getItem(position);
