...
public class ToDoFragment extends Fragment {
    ...
    private void initView(View view){
        filter = view.findViewById(R.id.toDoFilter);
        recyclerView = view.findViewById(R.id.toDoRec);
    }
    ...
    private void initListeners(){
        filter.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                recyclerViewModel.filterTicketToDo(s.toString());
            }
        });
    }

    private void initObservers(){
        recyclerViewModel.getToDoFilter().observe(this.getViewLifecycleOwner(), tickets -> {
